...
return (
  ...
  <Form>
    <h2 className="form-signin-heading"> Profile Update </h2>
      ...
      <div>
      <Button  variant="link" onClick={handleUpdate}>Update</Button>
      <p>If you want to delete your account please click  down <i className="down"></i></p>
      <Button  variant="link" onClick={handleDelete}>Deregister </Button>
      </div>
      </div>
  </Form>
  </div>
